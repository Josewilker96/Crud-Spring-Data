...
public class RelatoriosService {
	...
	public void inicial(Scanner scanner) {
		while (system) {
			...
			System.out.println("2 - Busca funcionario nome, data de contratação e salario maior");
			System.out.println("3 - Busca funcionario data contratação");
			System.out.println("4 - Pesquisa funcinario salario");
			...
			case 1:
				...
				break;
			case 2:
				buscaFuncinarioNomeSalarioMaiorData(scanner);
				break;
			case 3:
	...
	private void buscaFuncinarioNomeSalarioMaiorData(Scanner scanner) {
		System.out.println("Qual nome deseja pesquisar");
		String nome = scanner.next();
		...
		System.out.println("Qual salario maior deseja pesquisar");
	...
	private void pesquisafuncionarioSalario() {
		...
		list.forEach(f -> System.out.println("Funcinario: id: " + f.getId()
